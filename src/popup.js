...
console.log("Hello, world from popup!") // Log message for debugging 

// Put a badge next to extension "icon"
...
const checkbox = document.getElementById("enabled") // Get elem form html 
